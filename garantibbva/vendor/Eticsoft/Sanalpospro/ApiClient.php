...
class ApiClient
{
    ...
    {
        $settings = [
            'paythor_api_key' => EticConfig::get('GARANTIBBVA_TOKEN') ?? '',
            'paythor_public_key' => EticConfig::get('GARANTIBBVA_PUBLIC_KEY') ?? '',
            'paythor_secret_key' => EticConfig::get('GARANTIBBVA_SECRET_KEY') ?? '',
        ];
